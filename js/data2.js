...
const qnaList = [
  ...
  },
  {
    q: '2. 쉬는 날에는 당연히 ',
    a: [
      { answer: 'a. 이불밖은 위험해, 집에 있을래'},
      { answer: 'b. 시간아까워! 놀러나가야지'},
    ]
  },
  {
    q: '3. 좋아하는 계절은',
  ...
  },
  {
    q: '4. 여행을 떠나기 전에는',
    a: [
      { answer: 'a. 야무지게 계획을 짠다 '},
      { answer: 'b. 어떻게든 되겠지~ 별 생각 없다 '},
    ]
  },
  {
    q: '5. 전생을 믿나요?',
    a: [
      { answer: 'a. 아니? 인생은 단 한번 뿐이야'},
      { answer: 'b. 인연은 돌고 돌아 또 만난다고 믿어'},
    ]
  },
  ...
  },
  {
    q: '8. 외계인은 있을까?',
    a: [
      { answer: 'a. 있었으면 왜 지금까지 안 밝혀졌겠어?.'},
      { answer: 'b. 분명 어딘가에 존재하고 있을거야!'},
      { answer: 'c. 그런 생각은 다음에.. 먹고 살기도 바빠'},
    ]
  },
  {
    q: '9. 처음 보는 사람이 반갑게 내 이름을 부른다면,',
    a: [
      { answer: 'a. 당황하지 않은 척 나도 인사한다'},
      { answer: 'b. 놀란 얼굴로 "누구세요?" 묻는다'},
      { answer: 'c. 기억력이 좋아서 못 알아볼 리가 없다'},
    ]
  },
  {
    q: '10. 고된 여행길, 모르는 사람이 간식을 건넸을 때 ',
    a: [
      { answer: 'a. 고맙다고 인사한 뒤 한 입 베어문다'},
      { answer: 'b. 의심하다가 몰래 버린다'},
      { answer: 'c. 뭐야.. 이 사람 나 좋아하나?'},
    ]
  },
  {
    q: '11. 미용실에서 내가 요구한 길이의 <br>두배를 잘라버렸을 때 ',
    a: [
      { answer: 'a. 이건 아니지! 따지고서 돈을 깎는다'},
      { answer: 'b. 속상하지만 돈을 내고 집에 돌아와 운다'},
    ]
  },
  {
    q: '12. 운명을 믿는가? ',
    a: [
      { answer: 'a. 정해진 운명은 없어. 내가 개척해나가는거지'},
      { answer: 'b. 이 세상엔 내가 어쩔 수 없는 흐름이 있어'},
    ]
  },
  {
    q: '13. 나로 말할 것 같으면?',
    a: [
      { answer: 'a. 다정하고 스윗한 배려쟁이'},
      { answer: 'b. 엉뚱발랄한 4차원'},
      { answer: 'c. 담백하고 편안한 자연주의'},
    ]
  }
]
...
const infoList = [
  {
    name: 'Lv1. 친해지길 바라.. 어색한 사이',
    desc: '아직은 멀뚱멀뚱, 만나도 할 얘기가 그리 많지 않은 사이. 하지만 나중엔 왠지 엄청난 절친이 될 수 있을 것 같은 예감이 들어요. 궁금할 땐 선톡도 해보고, 프로필 뮤직이 괜찮으면 노래추천도 받으며 더욱 친해져보는 건 어때요?'
  },
  {
