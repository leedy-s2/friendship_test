...
const infoList = [
    ...
    },
    {
      ...
      desc: '일거수일투족을 함께 하진 않지만, 가끔 만나도 어색하지 않은 두 사람이에요.<br> 멀리 있어도 마음은 함께라지만 서로에 대해 조금 더 알아가는 노력이 필요해보여요. 자주 질문을 던지고 여유로울 때 산책도 하면서 친분을 유지하는 건 어떨까요?'
    },
    {
    ...
    {
      name: ' Lv4. 언제든 연락할 수 있는<br> 베스트 프렌드 ',
      desc: '누구보다 서로에게 솔직한 두 사람! 주변에서도 인정하는 베스트 프렌드에요. 힘든 일을 털어놓으면 언제든 달려나오는 두 사람은 인생에 없어선 안 될 서로의 필요충분조건! 앞으로도 따듯한 우정을 유지하고 오래오래 요!'
    },
    {
