const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 짬뽕', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: 'b. 짜장', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
      { answer: 'c. 난 둘 다', type: ['sheep', 'pig' ] },
    ]
  },
  {
    q: '2. 쉬는 날에는 당연히 ',
    a: [
      { answer: 'a. 이불밖은 위험해, 집에 있을래', type: ['mouse', 'rabbit', 'tiger', 'monkey'] },
      { answer: 'b. 시간아까워! 놀러나가야지', type: ['cow', 'horse', 'snake', 'dog'] },
    ]
  },
  {
    q: '3. 좋아하는 계절은',
    a: [
      { answer: 'a. 봄', type: ['cow', 'rabbit', 'tiger', 'dog', 'monkey'] },
      { answer: 'b. 여름', type: ['sheep', 'chick', 'pig'] },
      { answer: 'c. 가을', type: ['mouse', 'horse', 'snake', 'dragon'] },
      { answer: 'c. 겨을', type: ['mouse', 'horse', 'snake', 'dragon'] },
    ]
  },
  {
    q: '4. 여행을 떠나기 전에는',
    a: [
      { answer: 'a. 야무지게 계획을 짠다 ', type: ['cow', 'tiger', 'dragon' ] },
      { answer: 'b. 어떻게든 되겠지~ 별 생각 없다 ', type: ['sheep', 'dog', 'monkey', 'chick', 'pig' ] },
    ]
  },
  {
    q: '5. 전생을 믿나요?',
    a: [
      { answer: 'a. 아니? 인생은 단 한번 뿐이야', type: ['cow', 'sheep', 'dog', 'dragon', 'chick' ] },
      { answer: 'b. 인연은 돌고 돌아 또 만난다고 믿어', type: ['mouse', 'rabbit', 'horse', 'pig']},
    ]
  },

  {
    ...
    a: [
      { answer: 'a. 커리어', type: ['dragon', 'chick', 'pig' ] },
      { answer: 'b. 사랑', type: ['mouse', 'rabbit', 'horse', 'dog' ] },
      { answer: 'c. 우정', type: ['cow', 'sheep', 'tiger', 'snake', 'monkey' ] },
    ]
  },
  {
    q: '7. 가장 활동적인 시간은',
    a: [
      { answer: 'a. 아침이지!', type: ['cow', 'sheep', 'pig' ] },
      { answer: 'b. 저녁이다!', type: ['tiger', 'dragon', 'chick' ] },
    ]
  },
  {
    q: '8. 외계인은 있을까?',
    a: [
      { answer: 'a. 있었으면 왜 지금까지 안 밝혀졌겠어?.', type: ['mouse', 'dragon', 'chick' ] },
      { answer: 'b. 분명 어딘가에 존재하고 있을거야!', type: ['rabbit', 'tiger', 'horse', 'snake', 'dog', 'monkey' ] },
      { answer: 'c. 그런 생각은 다음에.. 먹고 살기도 바빠', type: ['cow', 'sheep', 'pig' ] },
    ]
  },
  {
    q: '9. 처음 보는 사람이 반갑게 내 이름을 부른다면,',
    a: [
      { answer: 'a. 당황하지 않은 척 나도 인사한다', type: ['sheep', 'mouse', 'snake', 'chick' ] },
      { answer: 'b. 놀란 얼굴로 "누구세요?" 묻는다', type: ['cow', 'rabbit', 'horse', 'pig' ] },
      { answer: 'c. 기억력이 좋아서 못 알아볼 리가 없다', type: ['tiger', 'dog', 'monkey', 'dragon' ] },
    ]
  },
  {
    q: '10. 고된 여행길, 모르는 사람이 간식을 건넸을 때 ',
    a: [
      { answer: 'a. 고맙다고 인사한 뒤 한 입 베어문다', type: ['dragon', 'chick', 'pig'] },
      { answer: 'b. 의심하다가 몰래 버린다', type: ['mouse', 'tiger', 'horse', 'snake' ] },
      { answer: 'c. 뭐야.. 이 사람 나 좋아하나?', type: ['cow', 'sheep', 'rabbit', 'dog', 'monkey' ] },
    ]
  },
  {
    q: '11. 미용실에서 내가 요구한 길이의 두배를 잘라버렸을 때 ',
    a: [
      { answer: 'a. 이건 아니지! 따지고서 돈을 깎는다', type: ['cow', 'dragon', 'chick', 'pig' ] },
      { answer: 'b. 속상하지만 돈을 내고 집에 돌아와 운다', type: ['sheep', 'mouse', 'rabbit', 'horse', 'dog'] },
    ]
  },
  {
    q: '12. 운명을 믿는가? ',
    a: [
      { answer: 'a. 정해진 운명은 없어. 내가 개척해나가는거지', type: ['cow', 'dragon', 'chick', 'pig' ] },
      { answer: 'b. 이 세상엔 내가 어쩔 수 없는 흐름이 있어', type: ['sheep', 'mouse', 'rabbit', 'horse', 'dog'] },
    ]
  },
  {
    q: '13. 나의 생년월일은?',
